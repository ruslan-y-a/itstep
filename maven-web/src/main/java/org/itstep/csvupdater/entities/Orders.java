...
public class Orders extends Entity {
	...
	public void cast(String name) {
		...
		if (name.equals("bonuspoints")) {this.bonuspoints= (Integer) entityValues.get("bonuspoints");}
		if (name.equals("currency")) {
			Currency currency = new Currency(); currency.setId((Long) entityValues.get("currency")); this.currency = currency; return;}
