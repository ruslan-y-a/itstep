...
public class Items extends Entity {
	...
	public void cast() {
		...
		Category category = new Category(); category.setId((Long) entityValues.get("category")); this.category = category;
		...
		Webpages webpages = new Webpages(); webpages.setId((Long) entityValues.get("webpages")); this.webpages = webpages;
	...
	public void cast(String name) {
		...
		if (name.equals("category")) {
			Category category = new Category(); category.setId((Long) entityValues.get("category")); this.category = category; return;}
		...
		if (name.equals("webpages")) {
			Webpages webpages = new Webpages(); webpages.setId((Long) entityValues.get("webpages")); this.webpages = webpages; return;}
