...
---------------------------------------------------
(   1, 'Special shoes'                       , NULL , 1           ),
(   2, 'Men\'s shoes'                        , NULL , 2           ),
(   3, 'Women\'s shoes'                      , NULL , 12          ),
(   4, 'Unisex shoes'                        , NULL , 24          ),
(   5, 'Type'                                , NULL , NULL        ),
(   6,         'Mens Boots'                  , 5    , 3           ),
...
INSERT INTO "stocks"
---------------------------------------------------
("id", "baseitemid" , "quantity" , "baseprice"  ) VALUES
---------------------------------------------------
(   1, 1          ,  10 ,0 ),
(   2, 2          ,  10 ,0 ),
(   3, 3           ,  10 ,0),
...
(  16, 16         ,  10 ,0);
-----------------------------------------------
SELECT setval('stocks_id_seq',16 );
--================================================================
...
("id","number","date"                   ,"dateexpired","baseitemid","customerid","quantity","sum",
 "currencyid","ordertype" ,"rejectionreason"  ,"statussold") VALUES
---------------------------------------------------
